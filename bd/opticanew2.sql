...
-- Volcando datos para la tabla opticanew.clientes: ~4 rows (aproximadamente)
...
INSERT IGNORE INTO `clientes` (`id_cli`, `nombre`, `apellido_paterno`, `apellido_materno`, `dir`, `telefono`, `sexo`, `email`) VALUES
	...
	(10, 'EDUARDO', 'Hernandez', 'Morales', 'pakistan', 2147483647, 'Masculino', 'psyo@gmail.com'),
	(11, 'Eduardo', 'Hernandez', 'Morales', 'asdaccsfsfskafa', 2147483647, 'Masculino', 'kratosedu18@gmail.com');
...
INSERT IGNORE INTO `empleado` (`codigo`, `nombre`, `apellido_paterno`, `apellido_materno`, `cargo`, `telefono`, `sexo`, `direccion`) VALUES
	(1, 'aaaa', 'aaa', 'aaass', 'Gerente de ventas', 1234567890, 'Femenino', 'aaaa'),
	(3, 'sarai', 'navarrete', 'hernandez', 'Gerente comercial', 2147483647, 'Femenino', 'nicaragua'),
	(10, 'Jorge', 'elduende', 'dealba', 'Gerente comercial', 2147483647, 'Masculino', 'neuro');
/*!40000 ALTER TABLE `empleado` ENABLE KEYS */;

-- Volcando estructura para tabla opticanew.login
CREATE TABLE IF NOT EXISTS `login` (
  `usuario` varchar(50) NOT NULL,
  `contraseña` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla opticanew.login: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `login` DISABLE KEYS */;
INSERT IGNORE INTO `login` (`usuario`, `contraseña`) VALUES
	('eduardo', '123');
...
INSERT IGNORE INTO `productos` (`idpro`, `codigo`, `tipo`, `tipo_armazon`, `cantidad`, `precio`, `descripcion`) VALUES
	(23, 1, 'Solares', 'Armazón de plastico', 1, 1, 'hola');
