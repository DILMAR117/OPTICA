...
$pdf->Cell(0,5,'ÓPTICA MIRAMOS POR TI',0,1,'C');
...
$result=mysqli_query($link, "select nombre,apellido_paterno,apellido_materno,dir,telefono,sexo,email from clientes"); 
