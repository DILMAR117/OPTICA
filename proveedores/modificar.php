...
<br/>
<br/>
<h1 ><center> Modificar Proveedores</center></h1>
               <?php
                      require_once("../bd/conexion.php");
                      $opcion = $_GET['codigo'];
                      $result=mysqli_query($link,"SELECT * FROM proveedor where codigo='$opcion'");
              ...
              <!-- Inicia la tabla -->
              <table width="100%">
              <form action="modificar_proveedores.php" method="post" id="frmmodificar_proveedores" >
              ...
              <tr class="espacio">
              <td align="right"> <label for="Direccion">Dirección:</label></td><td><input  type="txt" class="form-control" name="direccion" id="direccion"  value="<?php echo $consulta['direccion'];?>" required ></td>
              </tr>
              <tr class="espacio"> 
              </td> 
              ...
              <tr class="espacio">
              <td align="right"> <label for="correo">Correo Electronico:</label></td><td><input type="email" class="form-control" name="correo" id="correo"  value="<?php echo $consulta['correo'];?>"  required></td>
              </tr>
              <tr class="espacio">
              ...
              <td align="right"> <label for="empresa">Nombre de la Empresa:</label></td><td><input type="txt" class="form-control" name="empresa" id="empresa"  value="<?php echo $consulta['empresa'];?>"  required></td>
              </tr>
