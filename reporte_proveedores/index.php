...
$result=mysqli_query($link, "select nombre,direccion,telefono,correo,empresa from proveedor"); 
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $pdf->Cell(30,5, $row['correo'],1,0,'C');
    $pdf->Cell(50,5, $row['empresa'],1,0,'C');
