...
<h2><center></center></h2>
	...
	<br/>
	<br/>
			<h2><center> Registrar Clientes</center></h2>
			...
			<!-- Inicia la tabla -->
			<table width="100%">
			<form action="alta_clientes.php" method="post" id="alta_clientes">
			<tr class="espacio"> 
			...
			<tr class="espacio">
			<td align="right"> <label for="apellido_paterno">Apellido Paterno:</label></td><td><input type="text" class="form-control" name="apellido_paterno" minlength="3" maxlength="20" id="apellido_paterno" placeholder="Ingrese su primer apellido" autofocus required pattern="[a-zA-Z]+" title="ingrese solo letras"></td>
			</tr>
			<tr class="espacio"> 
			<td align="right"> <label for="apellido_materno">Apellido Materno:</label></td><td><input type="text" class="form-control" name="apellido_materno" minlength="3" maxlength="20" id="apellido_materno" placeholder="Ingrese su seguno apellido" autofocus required pattern="[a-zA-Z]+" title="ingrese solo letras"></td>
			</tr>
			<tr class="espacio">
			<td align="right"> <label for="Direccion">Dirección:</label></td><td><input  type="text" class="form-control" name="dir" id="dir" placeholder="Ingrese su dirección" required ></td>
			</tr>
			<tr class="espacio">
			...
			<td align="right"> <label for="Correo">Correo Eléctronico:</label></td><td><input type="email" class="form-control" name="email" id="email" placeholder="Ingrese su Correo Eléctronico"  required></td>
			</tr>
