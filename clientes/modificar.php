...
<br/>
<br/>
<h1 ><center> Modificar Clientes</center></h1>
               <?php
                      require_once("../bd/conexion.php");
                      $opcion = $_GET['id_cli'];
                      $result=mysqli_query($link,"SELECT * FROM clientes where id_cli='$opcion'");
              ...
              <!-- Inicia la tabla -->
              <table width="100%">
              <form action="modificar_clientes.php" method="post" id="frmmodificar_clientes" >
                <input type="hidden" class="form-control" name="id_cli" id="id_emp" value="<?php echo $consulta['id_cli'];?>"
              <tr class="espacio"> 
              <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" class="form-control" minlength="3" maxlength="20" name="nombre" id="nombre" value="<?php echo $consulta['nombre'];?>" autofocus required pattern="[a-zA-Z]+" title="ingrese solo letras sin espacios"></td>
              </tr> 
              <tr class="espacio">
              <td align="right"> <label for="apellido_paterno">Apellido Paterno:</label></td><td><input type="text" minlength="3" maxlength="20" class="form-control" name="apellido_paterno" id="apellido_paterno" value="<?php echo $consulta['apellido_paterno'];?>" autofocus required pattern="[a-zA-Z]+" title="ingrese solo letras"></td>
              </tr> 
              <tr class="espacio">
              <td align="right"> <label for="apellido_materno">Apellido Materno:</label></td><td><input type="text" minlength="3" maxlength="20" class="form-control" name="apellido_materno" id="apellido_materno" value="<?php echo $consulta['apellido_materno'];?>" autofocus required pattern="[a-zA-Z]+" title="ingrese solo letras"></td>
              </tr>
              <tr class="espacio"> 
              <td align="right"> <label for="Dirección">Dirección:</label></td><td><input type="text" class="form-control" name="dir" id="dir"  value="<?php echo $consulta['dir'];?>" required></td>
              </tr> 
